...
sns.catplot(x='Group',y="Powers",data=datos,hue='Study', dodge=True, kind="violin",col='Bands'c,col_wrap=2,legend=False,sharex=False,sharey=False,height=5, aspect=0.8)
